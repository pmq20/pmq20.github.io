...
\begin{proof}
\begin{enumerate}
\item We claim that $GL_n(\mathbb{R})$ is a subgroup of $G=GL_n(\mathbb{C})$. This can be shown by noticing that $\mathbb{R}$ is a field closed under multiplication and addition; the identity matrix is a real matrix; and the inverse of a real matrix is a real matrix because its determinant and minors are real and\[
