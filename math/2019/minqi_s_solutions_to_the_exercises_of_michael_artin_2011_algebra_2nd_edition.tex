...
\title{Minqi's Solutions to the Exercises of Michael Artin (2011), Algebra (2nd Edition)}
...
\section{Problem 1.1: The Row Index and the Column Index}
...
\section{Problem 1.2: Matrix Multiplication is not Commutative}
...
\section{Problem 1.3: Row$\times$Column and Column$\times$Row}
...
\section{Problem 1.4: Matrix Multiplication is Associative}
...
\section{Problem 1.5: The Number of Multiplications Required to Multiply 3 Matrices}
...
\section{Problem 1.6: $2\times2$ Upper Triangular Matrices}
...
\section{Problem 1.7: $3\times3$ Upper Triangular Matrices}
...
\section{Problem 1.8: Block Multiplications}
