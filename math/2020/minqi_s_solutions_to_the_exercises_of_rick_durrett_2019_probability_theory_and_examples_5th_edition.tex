...
&\dots.
\end{split}
\]where $0.1$ is the binary representation of $\frac{1}{2}$, etc. Then it is clear that\[
...
\]which is a contradiction, since $\mathcal{F}_{i_0}$ only contains intervals of rational endpoints.
\end{enumerate}
\end{proof}
