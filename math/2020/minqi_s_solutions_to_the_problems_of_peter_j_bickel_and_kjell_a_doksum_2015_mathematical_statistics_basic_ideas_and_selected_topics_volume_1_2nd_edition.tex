...
\end{split}
\]Let $\mathbf{X}:\Omega_1\to\mathbb{R}^{n_1}$ be the random vector on $\Omega_1$ defined by\[
\begin{split}
\mathbf{X}&\equiv(X_1,\dots,X_{n_1}),\\
X_i(I_1,\dots,I_{n_1})&\equiv\text{the blood pressure of }I_i\text{ measured after 1 hour of drug}.
\end{split}
\]Let $\mathbf{Y}:\Omega_2\to\mathbb{R}^{n_2}$ be the random vector on $\Omega_2$ defined by\[
\begin{split}
