...
Suppose we are comparing inplementations of insertion sort and merge sort on the same machine. For inputs of size $n$, insertion sort runs in $8n^2$ steps, while merge sort runs in $64n\lg n$ steps. For which values on $n$ does insertion sort beat merge sort?
\begin{proof}[Answer]
