...
I think a computer today has a 10\% chance of passing a five-minute Turing Test with an unskilled interrogator. In another 50 years a computer tend to have 50\% chance of passing a five-minute Turing Test as machines at that time might behave sufficiently deceptive to leave an unskilled interrogator no better than random guessing.
\end{proof}
\end{document}
