...
\begin{enumerate}
\item The Theological Objection. This objection still carries weight because contemporary knowledge about ``soul'', ``mind'' or ``consciousness'' is still not adequately available to easily trump theological arguments.
\item The ``Heads in the Sand'' Objection. This object does not carry weight because it is a fallacious ``appeal to consequences'' argument.
\item The Mathematical Objection. This objection still carries weight because some evidence has been produced in recent years regarding the orchestrated objective reduction.
\end{enumerate}
