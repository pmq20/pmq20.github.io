...
\item Lady Lovelace's Objection. This objection does not carry weight because it is only a historic remark made when evidence available to Lady Lovelace did not encourage her to believe that machines can indeed act something new. Latest development has proven machine learning to be feasible of producing surprising results more than ``whatever we know how to order it'' to perform. Turing's refutations are valid because machines can indeed surprise us and there is indeed virtue in the working out of consequences from data and general principles.
\end{enumerate}
