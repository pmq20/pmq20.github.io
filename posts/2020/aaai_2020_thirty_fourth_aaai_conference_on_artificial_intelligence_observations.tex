...
\item Hinton 团队提出了2019版堆叠式胶囊自动编码机 \cite{NIPS2019_9684} 用来解决 CNN 不面向对象、无坐标系标架、不能处理旋转、缩放等视角变换等问题，而且用到了 Set Transformer \cite{DBLP:journals/corr/abs-1810-00825}
